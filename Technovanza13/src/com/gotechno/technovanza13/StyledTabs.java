...
public class StyledTabs extends SherlockFragmentActivity {
    private static final String[] CONTENT = new String[] { "Autobots","iMech", "iBuild", "Eureka", "Manageria", "iCode", "Online", "Impulse", "Fun Events"  };
